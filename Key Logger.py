...
empty= Label(root, text="Ket Logger", font='Verdana 11 bold').grid(row=3,column=2)
empty = Label(root, text=" ").grid(row=4, column=0)
empty = Label(root, text=" ").grid(row=5, column=0)
Button(root, text="Start Key Logger", command=butaction).grid(row=6,column=2)
root.mainloop()
